...
vim.keymap.set("n", "<leader>tt", "<Cmd>lua require('vscode-neovim').call('go.test.cursorOrPrevious')<CR>") -- -- toggle test <> code
...
vim.keymap.set("n", "<leader>q", "<Cmd>lua require('vscode-neovim').call('problems.action.showQuickFixes')<CR>") -- quick fix
vim.keymap.set("n", "<leader>f", "<Cmd>lua require('vscode-neovim').call('editor.action.formatDocument')<CR>")
vim.keymap.set("n", "<leader>d", "<Cmd>lua require('vscode-neovim').call('editor.action.marker.next')<CR>") -- 次の問題 (エラー、警告、情報) へ移動 vim.diagnostic.goto_next
vim.keymap.set("n", "<leader>c", "<Cmd>lua require('vscode-neovim').call('editor.action.inlineSuggest.trigger')<CR>") -- 次の問題 (エラー、警告、情報) へ移動 vim.diagnostic.goto_next
...
-- [C]hat
-- vim.keymap.set("n", "ci", "<Cmd>lua require('vscode-neovim').call('')<CR>") --
vim.keymap.set("n", "c_", "<Cmd>lua require('vscode-neovim').call('editor.action.inlineSuggest.trigger')<CR>") -- インライン候補をトリガーする '/' は '_'で設定
